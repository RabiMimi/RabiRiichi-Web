...
export function ResultAnimation3D(): React.JSX.Element | null {
  ...
  return (
    ...
    >
      ...
      >
        <span
          className={`relative inline-block font-sans font-black text-5xl md:text-7xl lg:text-8xl tracking-[4px] text-white uppercase before:content-[attr(data-text)] before:absolute before:inset-0 before:z-[-1] before:[-webkit-text-fill-color:initial] before:bg-none before:[text-shadow:none] ${
