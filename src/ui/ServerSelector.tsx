        ...
        <div className="flex flex-col gap-1.5 mt-1">
          ...
          {selectedCustomServer && (
            <button
              ...
              disabled={isConnecting}
              className="w-full rounded-lg border border-[#772222] bg-[#551111] px-5 py-2.5 text-[0.9rem] font-semibold text-[#ff9999] cursor-pointer transition-all duration-200 hover:not-disabled:bg-[#772222]/80 active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed outline-none"
            >
